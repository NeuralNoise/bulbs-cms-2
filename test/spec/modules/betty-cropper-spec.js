...
describe('Image object', function () {
  ...
  it('should generate a proper url', function () {
    ...
    expect(image.url('16x9', 200, 'jpg')).to.equal('//localimages.avclub.com/9/16x9/200.jpg');

    image.id = 12345;

    expect(image.url('16x9', 200, 'jpg')).to.equal('//localimages.avclub.com/1234/5/16x9/200.jpg');
  });
