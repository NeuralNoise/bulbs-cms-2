...
angular.module('bulbsCmsApp.nonRestmodListPage', [
  ...
  .directive('nonRestmodListPage', function (SHARED_URL) {
    return {
      controller: function (_, $scope, $location, $parse) {
      ...
      templateUrl: SHARED_URL + 'non-restmod-list-page/non-restmod-list-page.html'
    };
  });
...
angular.module('bulbsCmsApp')
  .controller('CmsNotificationsCtrl', [
    '$q', '$window', '$scope', 'CMS_NAMESPACE', 'CmsNotificationsApi', 'CurrentUser',
      '_', 'moment',
    function ($q, $window, $scope, CMS_NAMESPACE, CmsNotificationsApi,
        CurrentUser, _, moment) {
